...
const pathMappings = {
  ...
  '/api/auth/me': '/auth/me',
  '/api/arbitration/airesponse': '/arbitration/airesponse',
  '/api/arbitration/uploadFileToAI': '/arbitration/uploadFileToAI',
  '/api/arbitration/generateAIResponse': '/arbitration/generateAIResponse',
  '/api/arbitration/readAIResponseFromFile': '/arbitration/readAIResponseFromFile',  
};
