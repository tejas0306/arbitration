...
// This file handles the /api/arbitration/draft/[id] endpoint
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  console.log(`🔄 API Proxy - Draft ID endpoint called: ${id}, Method: ${req.method}`);
  console.log('🔄 Backend URL:', API_URL);
  
  try {
    // Set the target URL in the backend
    const targetUrl = `${API_URL}/arbitration/draft/${id}`;
